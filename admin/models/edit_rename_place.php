...
class RenamePlaceModel
{
    ...
    function get_query($dbh, $tree_id)
    {
        $place_qry = "(SELECT pers_birth_place as place_edit FROM humo_persons WHERE pers_tree_id='" . $tree_id . "' GROUP BY pers_birth_place)
